...
public class TestIcebergSchemaToTypeInfo {
  ...
  public void testGenerateListTypeInfo() throws Exception {
    TypeInfo expected = TypeInfoFactory.getListTypeInfo(TypeInfoFactory.getPrimitiveTypeInfo(serdeConstants.DOUBLE_TYPE_NAME));
    Schema schema = new Schema(
  ...
  public void testComplexSchema() throws Exception {
    ...
    assertEquals(TypeInfoFactory.getListTypeInfo(TypeInfoFactory.getPrimitiveTypeInfo(serdeConstants.DOUBLE_TYPE_NAME)), types.get(3));
